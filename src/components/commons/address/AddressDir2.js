                ...
                <section className="bl_sect ly_flex" style={{height: 'calc(100% - 30px - 42px)'}}>
                        ...
                        <div className="hp_w90 hp_mt20 hp_alignC" style={{height: '10%'}}>
                            ...
                            <div style={{display: 'flex'}}>
                                <input type="text" className="hp_mt15 hp_floatL" onChange={handleKeywordChange}
                                       style={{width: '60%'}}/>
                                <input type="submit" className="el_btnS el_btnblueBord hp_ml5 hp_mt15 hp_floatR"
                                       value="검색" onClick={handleSearch} style={{width: '20%'}}/>
                                <button type="button" className="el_btnS el_btn8Bord hp_mt15" onClick={receiverAdd}
                                        style={{marginLeft: '10px', width: '20%'}}>추가
                                </button>
                            </div>
                        </div>
                        <div className="hp_w90 hp_mt30 hp_mb30 hp_alignC hp_bordDE hp_br5 hp_fBack"
                             style={{overflow: 'scroll', height: '265px'}}>
                            <table>
                                <thead>
                                <tr>
                                ...
                                {employees.map(employee => (
                                    <tr key={employee.emp_code}>
                                        <td><input type="checkbox" checked={selectEmp.includes(employee)}
                                                   onChange={() => checkboxChange(employee)}/></td>
                                        <td onClick={(e) => {
                                            e.stopPropagation();
                                            checkboxChange(employee);
                                        }}>{employee.dept_title}</td>
                                        <td onClick={(e) => {
                                            e.stopPropagation();
                                            checkboxChange(employee);
                    ...
                    <div className="ly_body hp_bordDE hp_margin15 hp_f9Back ly_flexC hp_f9Back ly_fdirecCol ly_fitemC"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style={{display: 'flex', justifyContent: 'flex-end', height: '12%'}}>
                                            <button type="button" className="el_btnS el_btn8Bord hp_mb10"
                                                    onClick={receiverClear}>삭제
                                            </button>
                                        </div>
                                        <div style={{
                                            width: '250px',
                        ...
                        <div className="hp_w95 ly_flexEnd hp_pb15" style={{marginTop: '-20px'}}>
                            <button type="submit" className="el_btnS el_btnblueBack hp_mr5" onClick={confirmHandle}>확인
                            </button>
                            <button type="button" className="el_btnS el_btn8Back" id="closeButton"
